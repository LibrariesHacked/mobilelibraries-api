...
const view_location_fields = ['mobile_id', 'current_stop_id', 'current_stop_departure', 'current_stop_name', 'previous_stop_id', 'previous_stop_departure', 'previous_stop_name', 'next_stop_id', 'next_stop_arrival', 'next_stop_name', 'updated', 'update_type', 'geox', 'geoy'];
...
module.exports.getMobileLocations = async () => {
    ...
    const query = 'select ' + view_location_fields.join(', ') + ' from vw_mobiles_location';
    try {
