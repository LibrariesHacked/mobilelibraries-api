...
const viewFields = ['id', 'origin_stop_id', 'origin_stop_name', 'destination_stop_id', 'destination_stop_name', 'distance', 'duration', 'route_line']
...
module.exports.getTripById = async (id) => {
  let trip = null
  try {
    const query = 'select ' + viewFields.join(', ') + ' ' + 'from vw_trips where id = $1'
